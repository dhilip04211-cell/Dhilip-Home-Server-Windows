...
A Windows EXE build is provided under `windows/`. Run `windows/build_windows.bat` on Windows, or use the GitHub Actions workflow to produce `DhilipHomeServer.exe`.
